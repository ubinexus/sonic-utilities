...
+-----------------------------+---------------+---------------+
| FG_NHG_PREFIX               | Next Hop      | Hash bucket   |
+=============================+===============+===============+
| NHG_PREFIX: 100.50.25.12/32 | 200.200.200.4 | 0             |
|                             |               | 1             |
|                             |               | 2             |
...
| FG_NHG_PREFIX           | Next Hop           | Hash bucket   |
+=========================+====================+===============+
| NHG_PREFIX: fc:05::/128 | 200:200:200:200::4 | 0             |
|                         |                    | 1             |
|                         |                    | 2             |
|                         |                    | 3             |
|                         |                    | 4             |
...
|                         |                    | 15            |
+-------------------------+--------------------+---------------+
| NHG_PREFIX: fc:05::/128 | 200:200:200:200::5 | 16            |
|                         |                    | 17            |
|                         |                    | 18            |
|                         |                    | 19            |
|                         |                    | 20            |
...
| FG_NHG_PREFIX           | Active Next Hops   |
+=========================+====================+
| NHG_PREFIX: fc:05::/128 | 200:200:200:200::4 |
|                         | 200:200:200:200::5 |
+-------------------------+--------------------+
"""
