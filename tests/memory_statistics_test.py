...
class TestMemoryStatisticsConfigCommands(unittest.TestCase):
    ...
    def test_memory_statistics_enable(self, mock_mod_entry):
        ...
        mock_mod_entry.assert_called_once_with("MEMORY_STATISTICS", "memory_statistics", {"enabled": "true"})
    ...
    def test_memory_statistics_disable(self, mock_mod_entry):
        ...
        # Ensure the entry was modified correctly
        mock_mod_entry.assert_called_once_with("MEMORY_STATISTICS", "memory_statistics", {"enabled": "false"})
    ...
    def test_memory_statistics_retention_period(self, mock_mod_entry):
        ...
        # Ensure the entry was modified correctly
        mock_mod_entry.assert_called_once_with("MEMORY_STATISTICS", "memory_statistics", {"retention_period": "15"})
    ...
    def test_memory_statistics_sampling_interval(self, mock_mod_entry):
        ...
        # Ensure the entry was modified correctly
        mock_mod_entry.assert_called_once_with("MEMORY_STATISTICS", "memory_statistics", {"sampling_interval": "5"})
