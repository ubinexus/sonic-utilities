...
class TestConfigVRRP(object):
    ...
    def test_add_del_vrrp_instance_without_vip(self):
        ...
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["add"], ["Ethernet63", "9.9.9.1/24"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        assert ('Ethernet63', '9.9.9.1/24') in db.cfgdb.get_table('INTERFACE')

        # config int vrrp remove Ethernet63 7
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["remove"], ["Ethernet63", "7"], obj=obj)
        print(result.exit_code, result.output)
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["add"], ["Ethernet63", "7"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["remove"], ["Ethernet63", "9.9.9.1/24"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code != 0
    ...
    def test_add_del_vrrp6_instance_without_vip(self):
        ...
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["add"], ["Ethernet63", "99::64/64"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["add"], ["Ethernet63", "7"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
    ...
    def test_add_del_vrrp_instance(self):
        ...
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["add"], ["Ethernet62", "8.8.8.1/24"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        assert ('Ethernet62', '8.8.8.1/24') in db.cfgdb.get_table('INTERFACE')

        # check interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["add"], ["Ethernt64", "8", "10.10.10.8/24"], obj=obj)
        print(result.exit_code, result.output)
        assert "'interface_name' is not valid" in result.output
        assert result.exit_code != 0

        # check interface is Router interface
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["add"], ["Ethernet2", "8", "10.10.10.8/24"], obj=obj)
        print(result.exit_code, result.output)
        assert "Router Interface 'Ethernet2' not found" in result.output
        assert result.exit_code != 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["add"], ["Ethernet62", "7", "0.0.0.0"], obj=obj)
        print(result.exit_code, result.output)
        assert "IPv4 address 0.0.0.0/32 is Zero" in result.output
        assert result.exit_code != 0

        # config int vrrp ip add Ethernet62 7 777.256.1.1/24
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["add"], ["Ethernet62", "7", "777.256.1.1/24"], obj=obj)
        print(result.exit_code, result.output)
        assert "IP address 777.256.1.1/24 is not valid" in result.output
        assert result.exit_code != 0

        # config int vrrp ip add Ethernet62 7 224.0.0.41/24
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["add"], ["Ethernet62", "7", "224.0.0.41/24"], obj=obj)
        print(result.exit_code, result.output)
        assert "IP address 224.0.0.41/24 is multicast" in result.output
        assert result.exit_code != 0

        # config int vrrp ip add Ethernet62 7 6.6.6.6
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["add"], ["Ethernet62", "7", "6.6.6.6"], obj=obj)
        print(result.exit_code, result.output)
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["remove"], ["Ethernet64", "8", "10.10.10.888/24"], obj=obj)
        print(result.exit_code, result.output)
        ...
        # check interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["remove"], ["Ethernt64", "8", "10.10.10.16/24"], obj=obj)
        print(result.exit_code, result.output)
        assert "'interface_name' is not valid" in result.output
        assert result.exit_code != 0

        # check interface is Router interface
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["ip"].commands["remove"], ["Ethernet2", "8", "10.10.10.16/24"], obj=obj)
        print(result.exit_code, result.output)
        assert "Router Interface 'Ethernet2' not found" in result.output
        assert result.exit_code != 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["remove"], ["Ethernet62", "8.8.8.1/24"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code != 0
    ...
    def test_add_del_vrrp6_instance(self):
        ...
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["add"], ["Ethernet63", "99::1/64"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        assert ('Ethernet63', '99::1/64') in db.cfgdb.get_table('INTERFACE')

        # config int ip add Ethernet62 88::1/64
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["add"], ["Ethernet62", "88::1/64"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        assert ('Ethernet62', '88::1/64') in db.cfgdb.get_table('INTERFACE')

        # check interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["add"], ["Ethernt64", "8", "100::8/64"], obj=obj)
        print(result.exit_code, result.output)
        assert "'interface_name' is not valid" in result.output
        assert result.exit_code != 0

        # check interface is Router interface
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["add"], ["Ethernet2", "8", "100::8/64"], obj=obj)
        print(result.exit_code, result.output)
        assert "Router Interface 'Ethernet2' not found" in result.output
        assert result.exit_code != 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["add"], ["Ethernet62", "7", "88::16/64"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["add"], ["Ethernet62", "7", "::"], obj=obj)
        print(result.exit_code, result.output)
        assert "IPv6 address ::/128 is unspecified" in result.output
        assert result.exit_code != 0

        # config int vrrp6 ipv6 add Ethernet62 7 785h::12/64
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["add"], ["Ethernet62", "7", "785h::12/64"], obj=obj)
        print(result.exit_code, result.output)
        assert "IP address 785h::12/64 is not valid" in result.output
        assert result.exit_code != 0

        # config int vrrp6 ipv6 add Ethernet62 7 88::2
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["add"], ["Ethernet62", "7", "88::2"], obj=obj)
        print(result.exit_code, result.output)
        ...
        # check interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["remove"], ["Ethernt64", "8", "100::16/64"], obj=obj)
        print(result.exit_code, result.output)
        assert "'interface_name' is not valid" in result.output
        assert result.exit_code != 0

        # check interface is Router interface
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["remove"], ["Ethernet2", "8", "100::16/64"], obj=obj)
        print(result.exit_code, result.output)
        assert "Router Interface 'Ethernet2' not found" in result.output
        assert result.exit_code != 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["ipv6"].commands["remove"], ["Ethernet64", "8", "88cg::2/64"], obj=obj)
        print(result.exit_code, result.output)
        ...
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["remove"], ["Ethernet63", "99::1/64"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code != 0
        assert ('Ethernet63', '99::1/64') not in db.cfgdb.get_table('INTERFACE')

        # config int ip remove Ethernet632 88::1/64
        result = runner.invoke(config.config.commands["interface"].commands["ip"].commands["remove"], ["Ethernet62", "88::1/64"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code != 0
    ...
    def test_add_del_vrrp_instance_track_intf(self):
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["track_interface"].commands["add"], ["Ethernet64", "8", "Ethernt5", "20"], obj=obj)
        print(result.exit_code, result.output)
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["track_interface"].commands["add"], ["Ethernet64", "8", "Ethernet6", "25"], obj=obj)
        print(result.exit_code, result.output)
        assert result.exit_code == 0
        assert ('Ethernet64', '8', 'Ethernet6') in db.cfgdb.get_table('VRRP_TRACK')
        ...
        # check interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["track_interface"].commands["remove"], ["Ethernt64", "8", "Ethernet5"], obj=obj)
        print(result.exit_code, result.output)
        assert "'interface_name' is not valid" in result.output
        assert result.exit_code != 0

        # check interface is Router interface
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["track_interface"].commands["remove"], ["Ethernet2", "8", "Ethernet5"], obj=obj)
        print(result.exit_code, result.output)
        assert "Router Interface 'Ethernet2' not found" in result.output
        assert result.exit_code != 0

        # check track_interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp"].commands["track_interface"].commands["remove"], ["Ethernet64", "8", "Ethernt5"], obj=obj)
        print(result.exit_code, result.output)
        assert "'track_interface' is not valid." in result.output
        assert result.exit_code != 0
    ...
    def test_add_del_vrrp6_instance_track_intf(self):
        ...
        # check track_interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["track_interface"].commands["add"], ["Ethernet64", "8", "Ethernt5", "20"], obj=obj)
        print(result.exit_code, result.output)
        assert "'track_interface' is not valid." in result.output
        assert result.exit_code != 0
        ...
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["track_interface"].commands["add"], ["Ethernet7", "8", "Ethernet5", "20"], obj=obj)
        print(result.exit_code, result.output)
        ...
        # check interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["track_interface"].commands["remove"], ["Ethernt64", "8", "Ethernet5"], obj=obj)
        print(result.exit_code, result.output)
        assert "'interface_name' is not valid" in result.output
        assert result.exit_code != 0

        # check interface is Router interface
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["track_interface"].commands["remove"], ["Ethernet2", "8", "Ethernet5"], obj=obj)
        print(result.exit_code, result.output)
        assert "Router Interface 'Ethernet2' not found" in result.output
        assert result.exit_code != 0

        # check track_interface_name is valid
        result = runner.invoke(config.config.commands["interface"].commands["vrrp6"].commands["track_interface"].commands["remove"], ["Ethernet64", "8", "Ethernt5"], obj=obj)
        print(result.exit_code, result.output)
        assert "'track_interface' is not valid." in result.output
        assert result.exit_code != 0
