...
class TestSwitchPortMigrator(object):
    ...
    def test_switchport_mode_migrator(self):
        ...
        click.echo(dbmgtr.configDB.get_table('PORT'))
        click.echo("expected port",expected_db.cfgdb.get_table('PORT'))
        click.echo("dbmgtr portccc",dbmgtr.configDB.get_table('PORTCHANNEL'))
        click.echo("dbmgtrcccc portccc",expected_db.cfgdb.get_table('PORTCHANNEL'))
        assert dbmgtr.configDB.get_table('PORT') == expected_db.cfgdb.get_table('PORT')
