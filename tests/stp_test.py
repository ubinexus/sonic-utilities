...
class TestStp(object):
    ...
    @pytest.mark.parametrize("command, args, expected_exit_code, expected_output", [
        ...
        (config.config.commands["spanning-tree"].commands["interface"].commands["enable"], ["Ethernet4"], 1, "Global STP is not enabled"),
        ...
        (config.config.commands["spanning-tree"].commands["interface"].commands["priority"], ["Ethernet4", "16"], 0, None),
        (config.config.commands["spanning-tree"].commands["interface"].commands["cost"], ["Ethernet4", "100"], 0, None),
        ...
        (config.config.commands["spanning-tree"].commands["interface"].commands["portfast"].commands["disable"], ["Ethernet4"], 0, None),
        (config.config.commands["spanning-tree"].commands["interface"].commands["portfast"].commands["enable"], ["Ethernet4"], 0, None),

        # Configure uplink fast disable and enable
        (config.config.commands["spanning-tree"].commands["interface"].commands["uplink_fast"].commands["disable"], ["Ethernet4"], 0, None),
        (config.config.commands["spanning-tree"].commands["interface"].commands["uplink_fast"].commands["enable"], ["Ethernet4"], 0, None),
        ...
        (config.config.commands["spanning-tree"].commands["interface"].commands["bpdu_guard"].commands["disable"], ["Ethernet4"], 0, None),
        (config.config.commands["spanning-tree"].commands["interface"].commands["bpdu_guard"].commands["enable"], ["Ethernet4", "--shutdown"], 0, None),
        (config.config.commands["spanning-tree"].commands["interface"].commands["bpdu_guard"].commands["disable"], ["Ethernet4"], 0, None),

        # Configure root guard enable and disable
        (config.config.commands["spanning-tree"].commands["interface"].commands["root_guard"].commands["enable"], ["Ethernet4"], 0, None),
        (config.config.commands["spanning-tree"].commands["interface"].commands["root_guard"].commands["disable"], ["Ethernet4"], 0, None),

        # Invalid cost and priority values
        (config.config.commands["spanning-tree"].commands["interface"].commands["cost"], ["Ethernet4", "0"], 1, "STP interface path cost must be in range 1-200000000"),
        (config.config.commands["spanning-tree"].commands["interface"].commands["cost"], ["Ethernet4", "2000000000"], 1, "STP interface path cost must be in range 1-200000000"),
        (config.config.commands["spanning-tree"].commands["interface"].commands["priority"], ["Ethernet4", "1000"], 1, "STP interface priority must be in range 0-240"),

        # Attempt to enable STP on interface with various conflicts
        (config.config.commands["spanning-tree"].commands["interface"].commands["enable"], ["Ethernet4"], 1, "STP is already enabled for"),
        (config.config.commands["spanning-tree"].commands["interface"].commands["enable"], ["Ethernet0"], 1, "has ip address"),
        (config.config.commands["spanning-tree"].commands["interface"].commands["enable"], ["Ethernet120"], 1, "is a portchannel member port"),
        (config.config.commands["spanning-tree"].commands["interface"].commands["enable"], ["Ethernet20"], 1, "has no VLAN configured"),
    ])
    ...
    (config.config.commands["vlan"].commands["member"].commands["add"], ["100", "Ethernet4"], 0, None),
    (config.config.commands["spanning-tree"].commands["enable"], ["pvst"], 0, None),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["cost"], ["100", "Ethernet4", "100"], 0, None),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["priority"], ["100", "Ethernet4", "32"], 0, None),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["cost"], ["100", "Ethernet4", "0"], 1, "STP interface path cost must be in range 1-200000000"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["cost"], ["100", "Ethernet4", "2000000000"], 1, "STP interface path cost must be in range 1-200000000"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["priority"], ["100", "Ethernet4", "1000"], 1, "STP per vlan port priority must be in range 0-240"),
    (config.config.commands["vlan"].commands["add"], ["101"], 0, None),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["priority"], ["101", "Ethernet4", "16"], 1, "is not member of"),
    ...
    (config.config.commands["spanning-tree"].commands["vlan"].commands["hello"], ["100", "0"], 1, "STP hello timer must be in range 1-10"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["hello"], ["100", "20"], 1, "STP hello timer must be in range 1-10"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["forward_delay"], ["100", "2"], 1, "STP forward delay value must be in range 4-30"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["forward_delay"], ["100", "42"], 1, "STP forward delay value must be in range 4-30"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["max_age"], ["100", "4"], 1, "STP max age value must be in range 6-40"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["max_age"], ["100", "45"], 1, "STP max age value must be in range 6-40"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["forward_delay"], ["100", "4"], 1, "2*(forward_delay-1) >= max_age >= 2*(hello_time +1 )"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["priority"], ["100", "70000"], 1, "STP bridge priority must be in range 0-61440"),
    (config.config.commands["spanning-tree"].commands["vlan"].commands["priority"], ["100", "8000"], 1, "STP bridge priority must be multiple of 4096"),
])
