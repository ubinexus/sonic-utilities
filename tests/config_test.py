...
class TestBMPConfig(object):
    ...
    def test_enable_bgp_neighbor_table(
        ...
        with mock.patch('utilities_common.cli.run_command') as mock_run_command:
            ...
            print(result.output)
            assert result.exit_code == 0
            mock_run_command.assert_any_call(['bmp', 'enable', 'bgp-neighbor-table'])
    ...
    def test_disable_bgp_neighbor_table(
        ...
        with mock.patch('utilities_common.cli.run_command') as mock_run_command1:
            ...
            print(result.output)
            assert result.exit_code == 0
            mock_run_command.assert_any_call(['bmp', 'disable', 'bgp-neighbor-table'])
    ...
    def test_enable_bgp_rib_in_table(
        ...
        with mock.patch('utilities_common.cli.run_command') as mock_run_command:
            ...
            print(result.output)
            assert result.exit_code == 0
            mock_run_command.assert_any_call(['bmp', 'enable', 'bgp-rib-in-table'])
            assert mock_run_command.call_count == 1
    ...
    def test_disable_bgp_rib_in_table(
        ...
        with mock.patch("utilities_common.cli.run_command", mock.MagicMock(side_effect=mock_run_command_side_effect)) as mock_run_command1:
            result = runner.invoke(config.config.commands["bmp"],
                                   ["disable", "bgp-rib-in-table"], obj=obj)
            print(result.exit_code)
            print(result.output)
            assert result.exit_code == 0
            mock_run_command.assert_any_call(['bmp', 'disable', 'bgp-rib-in-table'])
            assert mock_run_command1.call_count == 1
    ...
    def test_enable_bgp_rib_out_table(
        ...
        with mock.patch("utilities_common.cli.run_command", mock.MagicMock(side_effect=mock_run_command_side_effect)) as mock_run_command:
            ...
            print(result.output)
            assert result.exit_code == 0
            mock_run_command.assert_any_call(['bmp', 'enable', 'bgp-rib-out-table'])
            assert mock_run_command.call_count == 1
    ...
    def test_disable_bgp_rib_out_table(
        ...
        with mock.patch("utilities_common.cli.run_command", mock.MagicMock(side_effect=mock_run_command_side_effect)) as mock_run_command1:
            ...
            print(result.output)
            assert result.exit_code == 0
            mock_run_command.assert_any_call(['bmp', 'disable', 'bgp-rib-out-table'])
