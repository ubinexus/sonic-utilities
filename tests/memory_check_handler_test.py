""" These tests check the memory_check_handler script monit description string handling while the rest of auto thechsupport is unit tested by coredump_gen_handler_test.py """
...
import memory_check_handler


@patch("os.environ.get", lambda var: "status code 2 -- swss")
def test_memory_check_handler_host():
    with patch('memory_check_handler.invoke_ts_command_rate_limited') as invoke_ts:
        memory_check_handler.main()
