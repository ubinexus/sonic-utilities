...
if 'FRRouting' in p:
    ...
    def updates(direction, prefix):
        ...
        if direction is not None:
            command = ['sudo', 'vtysh', '-c', "no debug bgp updates " + direction]
        if prefix is not None:
            command = ['sudo', 'vtysh', '-c', "no debug bgp updates " + prefix]
        run_command(command)
    ...
    def zebra(prefix):
        ...
        if prefix is not None:
            command = ['sudo', 'vtysh', '-c', "no debug bgp zebra prefix " + prefix]
        run_command(command)
    ...
    def dplane(detailed):
        ...
        if detailed is not None:
            command = ['sudo', 'vtysh', '-c', "no debug zebra dplane detailed"]
        run_command(command)
