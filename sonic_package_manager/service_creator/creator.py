...
class ServiceCreator:
    ...
    def install_autogen_cli(self, package: Package, command: str):
        ...
        for module_name in self._get_yang_modules_for_auto_gen(package):
    ...
    def _get_yang_modules_for_auto_gen(self, package: Package):
        source_yang_modules = package.manifest['cli']['source-yang-modules']
