...
"PRIORITY",
    ...
    format_attr_value(
        entry,
        {'name': 'priority', 'description': 'Server priority', 'is-leaf-list': False, 'is-mandatory': False, 'group': ''}
    ),
]
...
"TIMEOUT",
    ...
    format_attr_value(
        entry,
        {'name': 'bind_dn', 'description': 'LDAP global bind dn', 'is-leaf-list': False, 'is-mandatory': False, 'group': ''}
    ),
    format_attr_value(
        entry,
        {'name': 'bind_password', 'description': 'Shared secret used for encrypting the communication', 'is-leaf-list': False, 'is-mandatory': False, 'group': ''}
    ),
    format_attr_value(
        entry,
        {'name': 'bind_timeout', 'description': 'Ldap bind timeout', 'is-leaf-list': False, 'is-mandatory': False, 'group': ''}
    ),
    format_attr_value(
        entry,
        {'name': 'version', 'description': 'Ldap version', 'is-leaf-list': False, 'is-mandatory': False, 'group': ''}
    ),
    format_attr_value(
        entry,
        {'name': 'base_dn', 'description': 'Ldap user base dn', 'is-leaf-list': False, 'is-mandatory': False, 'group': ''}
    ),
    format_attr_value(
        entry,
    ...
    format_attr_value(
        entry,
        {'name': 'timeout', 'description': 'Ldap timeout duration in sec', 'is-leaf-list': False, 'is-mandatory': False, 'group': ''}
    ),
]
