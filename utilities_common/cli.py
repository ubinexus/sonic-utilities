...
def is_ipv6addr_loopback(ipaddr):
    if ipaddress.ip_address("::1") == ipaddress.ip_address(ipaddr.split('/')[0]):
        return True
    if ipaddress.ip_address("::") == ipaddress.ip_address(ipaddr.split('/')[0]):
        return True
    return False
