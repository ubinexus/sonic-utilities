...
def _frr_get_asn_from_ip_neighbour(ipaddr, verbose=False):
    ...
    try:
        ...
        if verbose:
            print("local ASN for neighbor {} is {}".format(ipaddr, localAsnI))
...
"""
Keeping import config.main below to avoid cyclic dependency
"""
from config.main import run_command

"""
Help change bgp session for FRR
"""
