...
class Dash_Vnet_mapping(Executor):
    ...
    def execute(self, params):
        ...
        self.init_dash_vnet_mapping_table_config_info(dash_vnet_mapping_table_name)
        return self.ret_temp

    def init_dash_vnet_mapping_table_config_info(self, dash_vnet_mapping_table_name):
